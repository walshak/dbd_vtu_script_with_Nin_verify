<?php
    ...
    // 
        ...
        $plandesc = "Purchase of $quantity recharge pin of ".$networkDetails["network"]." ".$result['name']." ".$result['datatype']." At The Rate Of N{$discount}"; 
    ...
    if($result["status"]=="success"){
        ...
        $controller->saveRechargePin($userid,$body->ref,$businessname,$networkDetails["network"],$result["load_pin"],$result["quantity"],$result["serial"],$result["pin"]);
