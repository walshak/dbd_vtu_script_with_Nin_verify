...
<div class="page-content header-clear-medium">
        ...
        <div class="card card-style">
            ...
            <div class="content">
                <p class="mb-0 text-center font-600 color-highlight">Crytocurrencies Trade<p>
                ...
                <div class="row text-center mb-2">
                    ...
                    <a href="javascript:selectNetworkByIcon('MTN');" class="col-3 mt-2">
                        <span class="icon icon-l rounded-sm py-2 px-2" style="background:#f2f2f2;">
                            <img src="../../assets/images/icons/bitcoin.png" width="45" height="45" />
                        </span>
                    </a>
                    
                    <a href="javascript:selectNetworkByIcon('AIRTEL');" class="col-3 mt-2">
                        <span class="icon icon-l rounded-sm py-2 px-2" style="background:#f2f2f2;">
                            <img src="../../assets/images/icons/etherum.png" width="45" height="45" />
                        </span>
                    </a>
                    
                    <a href="javascript:selectNetworkByIcon('GLO');" class="col-3 mt-2">
                        <span class="icon icon-l rounded-sm py-2 px-2" style="background:#f2f2f2;">
                            <img src="../../assets/images/icons/usdt.png" width="45" height="45" />
                        </span>
                    </a>
                    
                    <a href="javascript:selectNetworkByIcon('9MOBILE');" class="col-3 mt-2">
                        <span class="icon icon-l rounded-sm py-2 px-2" style="background:#f2f2f2;">
                            <img src="../../assets/images/icons/pi.png" width="45" height="45" />
                        </span>
                    </a>
                ...
                <div class="d-flex">
                    ...
                    <marquee direction="left" scrollamount="5" style="background:#f2f2f2; padding:3px; border-radius:5rem;">
                        <h5 class="py-2">
                        [Bitcoin Wallet] - xxxxxxxxxxxxxxxxxxxxxxx [Etherum Wallet] - xxxxxxxxxxxxxxxxxxxxxx  [USDT Wallet] -xxxxxxxxxxxxxxxxxxxx [PI Wallet] - xxxxxxxxxxxxxxxxxxxxxxx
                        </h5>
                    </marquee>
                </div>
                <hr/>
