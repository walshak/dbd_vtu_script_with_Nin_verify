...
$data = loadViewRechargePinsData($controller);
...
<head>
    ...
    <title><?php echo $sitename; ?> - View Recharge Pins</title>
            ...
            <div class="content">
                <div class="d-flex justify-content-between mb-0">
                    ...
                    <div>
                        ...
                        <a href="print-recharge-pin.php?ref=<?php echo $_GET['ref']; ?>" class="btn btn-info"><i class="fa fa-print"></i> Print</a>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div>
                        ...
                        <div class="row border" style="margin: 3px;">
                            ...
                            <div class="col-8 bg-white" style="margin: 0; padding: 0;">
                                <div class="text-center" style="padding: 10px;">
                                    <h6><?php echo strtoupper($data->network); ?></h6>
                    ...
                    <?php endfor; else: ?>
                        <p class="text-center">No recharge pins found.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
