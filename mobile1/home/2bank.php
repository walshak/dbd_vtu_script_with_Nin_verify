...
<head>
    ...
    <title><?php echo $sitename; ?> - Transfer To Bank</title>
                ...
                <form method="post" class="airtimeForm" id="airtimeForm" action="buy-airtime">
                        <fieldset>
                            ...
                            <div class="input-style input-style-always-active has-borders mb-4">
                                ...
                                <select id="receiverbank" name="receiverbank">
                        <option value="Access Bank" style="color:#000000 !important;">Access Bank</option>
                              ...
                              <option value="Heritage Banking" style="color:#000000 !important;">Heritage Banking</option>
                  ...
                  <div class="input-style input-style-always-active has-borders validate-field mb-4">
                        ...
                        <div class="col-12 text-center font-15 mt-2">
                            <a class="text-dark" href="https://wa.me/message/ODTG4C4AA5R6E1"><b>CLICK TO TRANSFER TO BANK</b></a>
                        </div>
                    </div>
                    </form>        
            </div>
