            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="p-6 border-b border-gray-100">
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            @if(isset($configurations['paystackStatus']) && $configurations['paystackStatus']->config_value === 'On')
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('admin.system.wallet-providers.paystack.update') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="paystackStatus" name="paystackStatus" value="On"
                                    {{ isset($configurations['paystackStatus']) && $configurations['paystackStatus']->config_value === 'On' ? 'checked' : '' }}
                                ...
                                <label for="paystackStatus" class="ml-3 text-sm text-gray-700">
                                    <span class="status-text font-medium">{{ isset($configurations['paystackStatus']) && $configurations['paystackStatus']->config_value === 'On' ? 'Enabled' : 'Disabled' }}</span>
                                </label>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" name="paystackApi" id="paystackApi"
                                        value="{{ $configurations['paystackApi']->config_value ?? '' }}"
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" max="100" name="paystackCharges" id="paystackCharges"
                                    value="{{ $configurations['paystackCharges']->config_value ?? '1.5' }}" required
                        ...
                        <div>
                            ...
                            <div class="flex">
                                <input type="text" value="{{ url('/webhook/paystack') }}" readonly
                        ...
                        <div class="flex flex-wrap gap-3 pt-6">
                            ...
                            <a href="{{ route('admin.system.wallet-providers.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-medium transition-colors">
...
function copyWebhookUrl(provider) {
    const webhookUrl = `{{ url('/webhook') }}/${provider}`;
