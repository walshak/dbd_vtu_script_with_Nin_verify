...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        @foreach($availableReports as $key => $category)
        <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
            ...
            <div class="p-6">
                <ul class="space-y-3">
                    ...
                    <li>
                        <button onclick="generateReport('{{ $key }}', '{{ $reportKey }}')"
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-700 group-hover:text-gray-900 font-medium">{{ $reportName }}</span>
                            </div>
...
function submitReport(event) {
    ...
    switch(category) {
        case 'transaction_reports':
            route = '{{ route("reports.transaction") }}';
            break;
        case 'user_reports':
            route = '{{ route("reports.user") }}';
            break;
