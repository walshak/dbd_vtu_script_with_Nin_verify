                        ...
                        <div class="mt-6 lg:mt-0">
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl px-6 py-4 border border-white border-opacity-30">
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('fund-wallet') }}" class="text-xs text-blue-200 hover:text-white transition-colors">
                                ...
                                <label class="relative cursor-pointer network-option">
                                    ...
                                    <div class="network-card group bg-white border-2 border-gray-200 rounded-xl p-4 text-center hover:border-blue-300 hover:shadow-md peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:shadow-lg transition-all duration-300 transform hover:scale-105">
                                        <div class="flex flex-col items-center space-y-3">
                                            ...
                                            <!-- Network Info -->
                                            <div>
                                                <div class="font-bold text-gray-900 text-lg">{{ strtoupper($network->network) }}</div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center space-x-3">
                                <img src="{{ $network->logoPath }}" alt="{{ $network->network }}"
                                     class="h-5 w-auto"
                                     onerror="this.style.display='none'">
                                <span class="font-medium text-gray-700">{{ strtoupper($network->network) }}</span>
                            </div>
                            <span class="px-2 py-1 text-xs rounded-full {{ $network->isServiceEnabled('sme') ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                {{ $network->isServiceEnabled('sme') ? 'Active' : 'Inactive' }}
                            </span>
                        </div>
                        @endforeach
                    </div>
...
<x-modals.loading
    id="loadingModal"
    title="Processing..."
    message="Please wait while we process your data purchase"
/>
