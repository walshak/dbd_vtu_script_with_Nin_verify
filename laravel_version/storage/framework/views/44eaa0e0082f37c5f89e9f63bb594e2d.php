                                ...
                                <label class="relative cursor-pointer network-option">
                                    ...
                                    <div class="network-card group bg-white border-2 border-gray-200 rounded-xl p-4 text-center hover:border-blue-300 hover:shadow-md peer-checked:border-blue-500 peer-checked:bg-blue-50 peer-checked:shadow-lg transition-all duration-300 transform hover:scale-105">
                                        <div class="flex flex-col items-center space-y-3">
                                            ...
                                            <div class="relative">
                                                <?php if($network->logo_path && file_exists(public_path($network->logo_path))): ?>
                                                    <img src="<?php echo e(asset($network->logo_path)); ?>"
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HARDMOTIONS\Documents\work\dbd_vtu_script_with_Nin_verify\laravel_version\resources\views/data/index.blade.php ENDPATH**/ ?>