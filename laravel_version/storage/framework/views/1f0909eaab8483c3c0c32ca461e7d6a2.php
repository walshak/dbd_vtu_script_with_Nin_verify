...
<div class="space-y-6" id="dashboard-container">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Welcome back, <?php echo e(Auth::guard('admin')->user()->sysName ?? 'Admin'); ?>!</p>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="stat-value"><?php echo e(number_format($stats['total_users'] ?? 0)); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="stat-value text-green-600"><?php echo e(number_format($stats['active_users'] ?? 0)); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="stat-value text-purple-600"><?php echo e(number_format($stats['total_transactions'] ?? 0)); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="stat-value text-green-600">₦<?php echo e(number_format($stats['today_revenue'] ?? 0, 2)); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="stat-value text-indigo-600">₦<?php echo e(number_format($stats['month_revenue'] ?? 0, 2)); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="stat-value text-yellow-600"><?php echo e(number_format($stats['pending_transactions'] ?? 0)); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="stat-value text-green-600"><?php echo e(number_format($stats['successful_transactions'] ?? 0)); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="stat-value text-blue-600">₦<?php echo e(number_format($stats['total_wallet_balance'] ?? 0, 2)); ?></dd>
                    </dl>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            ...
            <?php if(isset($dashboardData['recent_transactions']) && count($dashboardData['recent_transactions']) > 0): ?>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $dashboardData['recent_transactions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
    ...
    <!-- Top Services -->
    <?php if(isset($dashboardData['top_services']) && count($dashboardData['top_services']) > 0): ?>
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <?php $__currentLoopData = $dashboardData['top_services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border rounded-lg p-4">
                        <h4 class="font-medium text-gray-900"><?php echo e($service['type']); ?></h4>
                        <div class="mt-2 space-y-1">
                            <p class="text-sm text-gray-600">Transactions: <?php echo e(number_format($service['count'])); ?></p>
                            <p class="text-sm text-gray-600">Revenue: ₦<?php echo e(number_format($service['revenue'], 2)); ?></p>
                            <p class="text-sm text-gray-600">Average: ₦<?php echo e(number_format($service['average'], 2)); ?></p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MrApollos\Documents\work\dbd_vtu_script_with_Nin_verify\laravel_version\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>