...
<?php $__env->startSection('title', 'Uzobest API Configuration'); ?>
<?php $__env->startSection('page-title', 'Uzobest API Configuration'); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between mb-4">
    <a class="btn btn-primary me-2" href="<?php echo e(route('admin.api-configuration.uzobest')); ?>">Uzobest (Default)</a>
    <a class="btn btn-secondary me-2" href="<?php echo e(route('admin.api-configuration.index')); ?>">General Settings</a>
    <a class="btn btn-info" href="<?php echo e(route('admin.system.wallet-providers.monnify')); ?>">Monnify Wallet</a>
</div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="box">
            ...
            <div class="box-body">
                <form method="post" action="<?php echo e(route('admin.api-configuration.update-uzobest')); ?>" class="form-submit">
                    <?php echo csrf_field(); ?>

                    <div class="form-group mb-3">
                        <label class="control-label font-medium">API Base URL</label>
                        <input type="text" name="uzobest_url" 
                               value="<?php echo e(config('services.uzobest.url')); ?>"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" id="uzobest_api_key" name="uzobest_api_key" 
                                   value="<?php echo e(env('UZOBEST_API_KEY')); ?>"
    ...
    <div class="col-12">
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <a href="<?php echo e(route('admin.api-configuration.data')); ?>" class="btn btn-block btn-outline-primary">
                            <i class="fa fa-wifi"></i><br>
                            Configure Data Plans
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo e(route('admin.api-configuration.airtime')); ?>" class="btn btn-block btn-outline-info">
                    ...
                    <div class="col-md-3">
                        <a href="<?php echo e(route('admin.transactions.index')); ?>" class="btn btn-block btn-outline-secondary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MrApollos\Documents\work\dbd_vtu_script_with_Nin_verify\laravel_version\resources\views/admin/api-configuration/uzobest.blade.php ENDPATH**/ ?>