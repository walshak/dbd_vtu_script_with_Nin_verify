<?php $__env->startSection('title', 'VASTLEAD  - Nigeria\'s Leading VTU Platform'); ?>
    ...
    <nav class="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 border-b border-gray-100">
        ...
        <div class="md:hidden mobile-menu hidden bg-white border-t border-gray-100">
            <div class="px-4 pt-2 pb-3 space-y-1">
                ...
                <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="block px-3 py-2 bg-blue-600 text-white rounded-lg mt-4">Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="block px-3 py-2 text-gray-600 hover:text-blue-600 font-medium">Sign In</a>
                        <a href="<?php echo e(route('register')); ?>" class="block px-3 py-2 bg-blue-600 text-white rounded-lg mt-2">Get Started</a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
                ...
                <div class="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 w-32 h-32 flex items-center justify-center">
                    ...
                    <img src="<?php echo e(asset('home/img/clients/mtn.png')); ?>" alt="MTN"
                ...
                <div class="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 w-32 h-32 flex items-center justify-center">
                    ...
                    <img src="<?php echo e(asset('home/img/clients/airtel.png')); ?>" alt="Airtel"
                         class="relative z-10 h-16 w-auto object-contain filter group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 w-32 h-32 flex items-center justify-center">
                    ...
                    <img src="<?php echo e(asset('home/img/clients/glo.png')); ?>" alt="Glo"
                         class="relative z-10 h-16 w-auto object-contain filter group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 w-32 h-32 flex items-center justify-center">
                    ...
                    <img src="<?php echo e(asset('home/img/clients/etisalat.png')); ?>" alt="9mobile"
                         class="relative z-10 h-16 w-auto object-contain filter group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div
                    ...
                    <img src="<?php echo e(asset('home/img/feature-2.png')); ?>" alt="Data" class="w-16 h-16 mx-auto mb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">
                        <a href="<?php echo e(route('login')); ?>" class="hover:text-blue-600 transition-colors">Buy cheap Data
                            Online</a>
                    </h3>
                ...
                <div
                    class="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    <img src="<?php echo e(asset('home/img/feature-2.png')); ?>" alt="Airtime" class="w-16 h-16 mx-auto mb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">
                        <a href="<?php echo e(route('login')); ?>" class="hover:text-blue-600 transition-colors">Buy Airtime</a>
                    </h3>
                ...
                <div
                    class="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    <img src="<?php echo e(asset('home/img/feature-3.png')); ?>" alt="Convert" class="w-16 h-16 mx-auto mb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">
                        <a href="<?php echo e(route('login')); ?>" class="hover:text-blue-600 transition-colors">Convert Airtime to
                            Cash</a>
                    </h3>
                ...
                <div
                    class="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    <img src="<?php echo e(asset('home/img/feature-3.png')); ?>" alt="WAEC" class="w-16 h-16 mx-auto mb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">
                        <a href="<?php echo e(route('login')); ?>" class="hover:text-blue-600 transition-colors">Waec ePins</a>
                    </h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HARDMOTIONS\Documents\work\dbd_vtu_script_with_Nin_verify\laravel_version\resources\views/welcome.blade.php ENDPATH**/ ?>