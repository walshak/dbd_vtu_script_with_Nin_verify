<?php $__env->startSection('title', 'Login - VASTLEAD '); ?>
            ...
            <form id="login-form" method="post" class="space-y-6">
                ...
                <div class="px-2">
                    ...
                    <div class="pt-5 mb-3 space-y-3 text-center">
                        <div class="text-sm">
                            <a class="text-gray-600 hover:text-blue-600 transition-colors" href="<?php echo e(route('password.request')); ?>">
                                Forget Password? Recover It
                            </a>
                        </div>
                        <div class="text-sm">
                            <a class="text-gray-600 hover:text-blue-600 transition-colors" href="<?php echo e(route('register')); ?>">
                                New User? Create Account
                            </a>
                        </div>
                        <div class="text-sm">
                            <a class="text-gray-600 hover:text-blue-600 transition-colors" href="<?php echo e(route('welcome')); ?>">
                                <b>VTU Platform</b>
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HARDMOTIONS\Documents\work\dbd_vtu_script_with_Nin_verify\laravel_version\resources\views/auth/login.blade.php ENDPATH**/ ?>