<?php $__env->startSection('title', 'Cable Plans Management'); ?>
        ...
        <div class="overflow-x-auto">
            <table id="cablePlansTable" class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $cnt = 1; ?>
                    <?php $__empty_1 = true; $__currentLoopData = $cablePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" class="plan-checkbox rounded border-gray-300 text-blue-600 focus:ring-blue-500" value="<?php echo e($plan->cpId); ?>">
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="text-sm text-gray-500">
                                <?php echo e($plan->provider ? $plan->provider->provider : 'Unknown Provider'); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-blue-600">
                                ₦<?php echo e(number_format($plan->cost_price ?? $plan->price, 2)); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-green-600">
                                ₦<?php echo e(number_format($plan->selling_price ?? $plan->userprice, 2)); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <button onclick="editCablePlan(<?php echo e($plan->cpId); ?>)"
                                        class="text-blue-600 hover:text-blue-900 transition-colors duration-150">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button onclick="togglePlanStatus(<?php echo e($plan->cpId); ?>)"
                                ...
                                <button onclick="deletePlan(<?php echo e($plan->cpId); ?>)"
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <select name="provider" id="provider" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($provider->cId); ?>"><?php echo e(strtoupper($provider->provider)); ?></option>
...
function submitCablePlan() {
    ...
    fetch('<?php echo e(route("admin.cable-plans.store")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
...
function editCablePlan(planId) {
    ...
    fetch(`<?php echo e(url('/admin/cable-plans')); ?>/${planId}`)
    .then(response => response.json())
    .then(data => {
        if (data.success) {
...
function togglePlanStatus(planId) {
    fetch(`<?php echo e(url('/admin/cable-plans')); ?>/${planId}/toggle-status`, {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
            'Content-Type': 'application/json'
...
function performBulkUpdate() {
    ...
    fetch('<?php echo e(route("admin.cable-plans.bulk-update-prices")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
function exportPlans() {
    window.location.href = '<?php echo e(route("admin.cable-plans.export")); ?>?format=csv';
}
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MrApollos\Documents\work\dbd_vtu_script_with_Nin_verify\laravel_version\resources\views/admin/cable-plans/index.blade.php ENDPATH**/ ?>