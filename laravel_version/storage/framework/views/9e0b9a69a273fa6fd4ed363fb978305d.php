                        ...
                        <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl px-4 py-3">
                            <div class="flex items-center space-x-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-bold" id="walletBalance">₦<?php echo e(number_format(auth()->user()->wallet_balance ?? 0, 2)); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.progress-indicator','data' => ['steps' => ['Select Network', 'Enter Details', 'Complete Purchase'],'currentStep' => 1,'color' => 'green']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['steps' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Select Network', 'Enter Details', 'Complete Purchase']),'currentStep' => 1,'color' => 'green']); ?>
                        ...
                        <div role="radiogroup" aria-labelledby="network-label" aria-required="true">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div class="network-option" data-network="<?php echo e(strtolower($network->network)); ?>">
                                    <input type="radio"
                                           id="network-<?php echo e(strtolower($network->network)); ?>"
                                           name="network"
                                           value="<?php echo e(strtolower($network->network)); ?>"
                                           class="sr-only"
                                           required
                                           aria-describedby="network-error"
                                           aria-invalid="false">
                                    <label for="network-<?php echo e(strtolower($network->network)); ?>"
                                        ...
                                        <div class="bg-gradient-to-br from-green-100 to-blue-100 w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-3 group-hover:shadow-lg">
                                            <?php if($network->logoPath && file_exists(public_path($network->logoPath))): ?>
                                                <img src="<?php echo e(asset($network->logoPath)); ?>" alt="<?php echo e($network->network); ?>" class="w-12 h-12 object-contain">
                                            <?php else: ?>
                                                <div class="w-12 h-12 rounded-lg flex items-center justify-center"
                                                     style="background: <?php echo e($network->brand_color ?? '#10b981'); ?>">
                                                    <span class="text-white font-bold text-lg"><?php echo e(strtoupper(substr($network->network, 0, 1))); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <h3 class="font-semibold text-gray-900 text-lg"><?php echo e(strtoupper($network->network)); ?></h3>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 md:grid-cols-6 gap-3 mb-4" role="group" aria-label="Quick amount selection">
                                ...
                                <button type="button"
                                        ...
                                        aria-label="Select <?php echo e($amount); ?> naira"
                                        tabindex="0">
                                    ₦<?php echo e($amount); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.success','data' => ['id' => 'successModal','title' => 'Purchase Successful!','showReceipt' => true,'showClose' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'successModal','title' => 'Purchase Successful!','showReceipt' => true,'showClose' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.error','data' => ['id' => 'errorModal','title' => 'Purchase Failed','buttonText' => 'Try Again']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'errorModal','title' => 'Purchase Failed','buttonText' => 'Try Again']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modals.loading','data' => ['id' => 'loadingModal','title' => 'Processing...','message' => 'Please wait while we process your airtime purchase']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'loadingModal','title' => 'Processing...','message' => 'Please wait while we process your airtime purchase']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
$(document).ready(function() {
    ...
    function validatePhoneNetwork() {
        ...
        $.ajax({
            url: '<?php echo e(route("phone.validate")); ?>',
            type: 'POST',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
                phone: phone,
    ...
    function loadRecentTransactions() {
        $.ajax({
            url: '<?php echo e(route("transactions.recent")); ?>',
            type: 'GET',
    ...
    window.downloadReceipt = function() {
        if (lastSuccessfulTransaction && lastSuccessfulTransaction.reference) {
            const baseUrl = '<?php echo e(url("transactions/receipt")); ?>';
...
<?php echo $__env->make('layouts.user-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HARDMOTIONS\Documents\work\dbd_vtu_script_with_Nin_verify\laravel_version\resources\views/airtime/index.blade.php ENDPATH**/ ?>