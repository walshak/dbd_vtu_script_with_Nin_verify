<?php $__env->startSection('title', 'Wallet Providers'); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-200">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div>
                        <?php if(($configurations['monifyStatus']->config_value ?? 'Off') === 'On'): ?>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <div class="font-semibold text-gray-900"><?php echo e($configurations['monifyCharges']->config_value ?? 'Not Set'); ?>%</div>
                    </div>
                    <div>
                        <div class="flex items-center text-sm text-gray-500 mb-1">
                        ...
                        <div class="font-semibold text-gray-900">
                            ...
                            ?>
                            <?php echo e($activeServices); ?>/4 Active
                        </div>
                    </div>
                </div>

                <a href="<?php echo e(route('admin.system.wallet-providers.monnify')); ?>" class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-center inline-block transition-colors duration-200">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-200">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div>
                        <?php if(($configurations['paystackStatus']->config_value ?? 'Off') === 'On'): ?>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                <i class="fas fa-check-circle mr-1"></i>Active
                            </span>
                        <?php else: ?>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <div class="font-semibold text-gray-900"><?php echo e($configurations['paystackCharges']->config_value ?? 'Not Set'); ?>%</div>
                    </div>
                    <div>
                        <div class="flex items-center text-sm text-gray-500 mb-1">
                        ...
                        <div class="font-semibold text-gray-900">
                            <?php echo e(!empty($configurations['paystackApi']->config_value ?? '') ? 'Configured' : 'Not Set'); ?>

                        </div>
                    </div>
                </div>

                <a href="<?php echo e(route('admin.system.wallet-providers.paystack')); ?>" class="w-full bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-center inline-block transition-colors duration-200">
                    <i class="fas fa-cog mr-2"></i>Configure
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-200">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                            <i class="fas fa-layer-group mr-1"></i><?php echo e($apiProviders->count()); ?> Providers
                        </span>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="font-semibold text-gray-900 mb-3"><?php echo e($configurations['walletOneProviderName']->config_value ?? 'Not Set'); ?></div>

                    <div class="space-y-1 text-sm text-gray-600">
                        <?php if(!empty($configurations['walletOneProviderName']->config_value ?? '')): ?>
                            <div class="flex items-center">
                                <i class="fas fa-check text-green-500 mr-2"></i>
                                <span>Wallet 1: <?php echo e($configurations['walletOneProviderName']->config_value); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($configurations['walletTwoProviderName']->config_value ?? '')): ?>
                            <div class="flex items-center">
                                <i class="fas fa-check text-green-500 mr-2"></i>
                                <span>Wallet 2: <?php echo e($configurations['walletTwoProviderName']->config_value); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if(!empty($configurations['walletThreeProviderName']->config_value ?? '')): ?>
                            <div class="flex items-center">
                                <i class="fas fa-check text-green-500 mr-2"></i>
                                <span>Wallet 3: <?php echo e($configurations['walletThreeProviderName']->config_value); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>

                <a href="<?php echo e(route('admin.system.wallet-providers.wallet-api')); ?>" class="w-full bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-center inline-block transition-colors duration-200">
                    <i class="fas fa-cog mr-2"></i>Configure
                </a>
            </div>
        </div>
...
function getWalletBalances() {
    ...
    fetch('<?php echo e(route("admin.system.wallet-providers.balances")); ?>')
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MrApollos\Documents\work\dbd_vtu_script_with_Nin_verify\laravel_version\resources\views/admin/wallet-providers/index.blade.php ENDPATH**/ ?>