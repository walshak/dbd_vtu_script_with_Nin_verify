<?php $__env->startSection('title', 'Admin Login - VASTLEAD '); ?>
...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-800 to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white rounded-2xl shadow-2xl p-8">
        <div class="text-center">
            <div class="pb-3 pt-3">
                <img src="<?php echo e(asset('assets1/images/stanlogo.jpg')); ?>" class="mx-auto h-20 w-auto rounded-r-2xl" alt="VASTLEAD " />
            </div>
        ...
        <form id="admin-login-form" class="mt-8 space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                    <a href="<?php echo e(url('/')); ?>" class="font-medium text-red-600 hover:text-red-500">
                        Back to site
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MrApollos\Documents\work\dbd_vtu_script_with_Nin_verify\laravel_version\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>